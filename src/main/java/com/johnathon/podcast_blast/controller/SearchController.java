...
public class SearchController {
    ...
    private ResponseEntity<? extends Serializable> fullTextSearch(@Valid @RequestBody SearchForm searchForm){
        ...
        JSONObject jsonObject = webClientBuilder
                ...
                .build()
                .get()
                .uri(baseURL + "/search?sort_by_date=1&type=episode&offset=0&len_min=10&len_max=200&published_before=1580172454000&published_after=0&only_in=title,description,author,audio&language=English&q=" + searchForm.getTextInput())
                .retrieve()
